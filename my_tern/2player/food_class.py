...
class Food:
    def __init__(self ,canvas: tkinter.Canvas):
        ...
        with open(data_path, 'r') as f:
            ...
            x = random.randint(1, int((data["window"]["window_width"]/self.pixel_size))-2) * self.pixel_size
            y = random.randint(1, int((data["window"]["window_height"]/self.pixel_size))-2) * self.pixel_size
